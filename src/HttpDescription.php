...
class HttpDescription
{
    public static array $codesDescriptionsRU = [
        ...
        403 => 'Доступ запрещен. Вероятно, Cloudflare или другая защита сайта блокирует нашего бота. Если сайт принадлежит вам, попробуйте добавить useragent "PackBot/2.0 (+https://t.me/packhelperbot)" или IP-адрес "212.162.153.137" в белый список, чтобы бот мог проверять сайт.',
        ...
        526 => 'Скорее всего, что-то не так с SSL-сертификатом.',
    ];
