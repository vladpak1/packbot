...
class HttpDescription {
    ...
    public static array $codesDescriptionsRU = array(
        ...
        500 => 'Внутренняя ошибка сервера. Это значит, что сервер обнаружил непредвиденную ситуацию, которая не позволяет ему выполнить запрос.',
        501 => 'Не реализовано. Это значит, что сервер не поддерживает возможность, необходимую для обработки запроса.',
        502 => 'Плохой шлюз. Это значит, что сервер выступает в роли шлюза или прокси и получил недействительный ответ от вышестоящего сервера.',
