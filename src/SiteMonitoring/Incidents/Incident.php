...
class Incident extends Entity
{
    ...
    {
        if ($this->isIncidentResolved()) {
            throw new IncidentException("Incident with ID $this->id is already resolved.");
        }
    ...
    protected function getIncidentFromDB()
    {
        ...
        if (!$incident) {
            throw new IncidentException("Incident with ID $this->id does not exist.");
        }
