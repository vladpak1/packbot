...
class CurlResponse extends Entity implements \JsonSerializable
{
    ...
    public function __construct(array $response)
    {
        ...
        $this->isOK      = 200 === $this->response['curlInfo']['http_code'];
    ...
    protected function tryToDetermineError()
    {
        ...
        if (200 != $this->getCode()) {
            $this->curlError = 'HTTP code is not 200, it is ' . $this->getCode() . ' (' . HttpDescription::getCodeDescription($this->getCode(), 'en_US') . ').';
        }
    }
}
